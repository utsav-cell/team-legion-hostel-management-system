...
<head>
    ...
    <style>
        ...
        .capacity-badge { display: inline-flex; align-items: center; gap: 0.3rem; padding: 0.25rem 0.65rem; border-radius: 999px; font-size: 0.72rem; font-weight: 700; }
        .capacity-badge::before { content: ''; width: 5px; height: 5px; border-radius: 50%; background: currentColor; }
        .capacity-badge.ok { background: rgba(16,185,129,0.12); color: #059669; }
        .capacity-badge.full { background: rgba(239,68,68,0.12); color: #dc2626; }

        .booking-notes { font-size: 0.85rem; color: var(--text); background: rgba(99,102,241,0.05); border-left: 3px solid var(--primary); border-radius: 6px; padding: 0.65rem 0.9rem; margin-bottom: 1rem; line-height: 1.5; }
