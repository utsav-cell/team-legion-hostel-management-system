...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($ticket_id < 1) {
        ...
        if (!$admin_note) {
            ...
            if ($tkt) {
                try {
                    $body = '<p>Your support ticket has been resolved by our admin team.</p>'
                          ...
                          . '<tr style="background:#f8fafc;"><td style="padding:8px 6px;color:#64748b;">Admin Note</td><td style="padding:8px 6px;">' . nl2br(htmlspecialchars($admin_note)) . '</td></tr>'
                          . '</table>';
                    $html = render_branded_email([
                        'name'      => $tkt['name'],
                        'kicker'    => 'Support Ticket',
                        'title'     => 'Your ticket has been resolved',
                        'intro'     => 'We have reviewed your request and provided a response below.',
                        'body_html' => $body,
                        'footnote'  => 'If you have further questions, please submit a new support ticket from your dashboard.',
                        'accent'    => '#10b981',
                        'accent2'   => '#059669',
                    ]);
                    send_app_mail($tkt['email'], $tkt['name'], 'Your support ticket has been resolved — HMS', $html);
                } catch (Exception $e) {
