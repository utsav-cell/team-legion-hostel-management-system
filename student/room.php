...
<head>
    ...
    <style>
        ...
        .mr-rm-empty { background:#fff; border:1.5px dashed var(--border); border-radius:12px; padding:1.5rem 1.25rem; text-align:center; color:var(--muted); font-size:0.85rem; }
