...
// A room is bookable if it isn't under maintenance and still has at least one free
// bed. We deliberately accept BOTH 'available' AND 'occupied' rows when free beds
// remain — this protects against rooms wrongly marked 'occupied' on the first
// booking (e.g. a triple with 1/3 filled should stay visible).
$where  = ["status <> 'maintenance'", 'deleted_at IS NULL', $capacity_filter];
$params = [];
    ...
    ?>
        ...
        <div class="br-pending-banner">
            ...
            <div class="br-pending-banner-body">
                <b>Move request in the queue</b> &mdash; you asked to switch to Room <?= e($cd['pending_transfer']['to_room']) ?> on <?= e(date('d M Y', strtotime($cd['pending_transfer']['created_at']))) ?>. The warden hasn't looked at it yet.
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="br-quick-actions">
            <a href="payments.php" class="br-quick">
                ...
                <div>
                    <div class="br-quick-title">Pay your fees</div>
                    <div class="br-quick-desc">See what's due, pay through eSewa</div>
                </div>
            </a>
            <a href="request_transfer.php" class="br-quick">
                ...
                <div>
                    <div class="br-quick-title">Switch rooms</div>
                    <div class="br-quick-desc">Ask to move somewhere else</div>
                </div>
            </a>
            <a href="my_complaints.php" class="br-quick">
                ...
                <div>
                    <div class="br-quick-title">Something off?</div>
                    <div class="br-quick-desc">Tell us about it — we'll fix it</div>
                </div>
            </a>
            <a href="request_leave.php" class="br-quick">
                ...
                <div>
                    <div class="br-quick-title">Going home for a bit?</div>
                    <div class="br-quick-desc">Apply for leave</div>
                </div>
            </a>
        </div>
        ...
        <div class="br-amenities">
            <div class="br-amenities-head">
                <h3>What comes with your room</h3>
                <span class="pill">All in</span>
            </div>
            <div class="br-amenities-sub">All of this is part of your monthly fee. Nothing extra to pay.</div>
