    ...
    foreach ($staff as $s) {
        try {
            $body = "<p>Hi " . htmlspecialchars($s['name']) . ",</p>"
                  . "<p>A new room booking is waiting on your approval:</p>"
                  . "<ul>"
                  ...
                  . "</ul>"
                  . "<p>Head to the warden dashboard → Booking Requests when you have a moment.</p>";
            send_app_mail($s['email'], $s['name'], 'New booking request waiting', $body);
