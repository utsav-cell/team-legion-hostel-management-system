...
function render_sidebar($active_page) {
    ...
    $menus = [
        ...
        'warden' => [
            ...
            ['href' => 'room_requests.php',              'label' => 'Room Requests', 'icon' => 'key'],
        ...
        'owner' => [
            ...
            ['href' => 'booking_approvals.php', 'label' => 'Booking Approvals', 'icon' => 'clipboard'],
        ],
        'admin' => [
            ['href' => 'dashboard.php',       'label' => 'Dashboard',    'icon' => 'chart'],
...
function render_footer(): string {
    return '<footer style="margin-left:250px;padding:1.5rem 2.5rem;border-top:1px solid var(--border);background:var(--panel);display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:0.5rem;font-size:0.78rem;color:var(--muted);">'
         . '<span>HMS Student Residence &nbsp;&bull;&nbsp; Thamel, Kathmandu</span>'
         . '<span>&copy; ' . date('Y') . ' HMS &nbsp;&bull;&nbsp; All rights reserved</span>'
         . '</footer>';
}
